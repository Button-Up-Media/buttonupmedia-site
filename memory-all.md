...
- The optimized MP4 pass now keeps the original AAC audio tracks for the videos that had sound, so hover/tap testimonials and social clips still play with audio instead of silently looping.
